...
\begin{DoxyCode}
875         \{
876             \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(v ? 1 : 0);
877         \}
\end{DoxyCode}
...
\begin{DoxyCode}
735         \{
736             \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t} i = 0; i < count; i++)
737                 writeByte(array[i]);
738         \}
\end{DoxyCode}
...
Definition at line 828 of file stream.\+h.


\begin{DoxyCode}
829         \{
830             static\_assert(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{float}) == \textcolor{keyword}{sizeof}(uint32\_t), \textcolor{stringliteral}{"float is not 32 bits"});
831 \textcolor{comment}{}
832 \textcolor{comment}{            /**}
833 \textcolor{comment}{             * @brief Write what the function does here}
834 \textcolor{comment}{             *}
835 \textcolor{comment}{             * @return}
836 \textcolor{comment}{             **/}
837             \textcolor{keyword}{union}
838             \{
839                 uint32\_t ival;
840                 \textcolor{keywordtype}{float} fval;
841             \};
842             fval = v;
843             \hyperlink{classWriter_ab8ed28096897dc429c95290542389224}{writeU32}(ival);
844         \}
\end{DoxyCode}
...
Definition at line 851 of file stream.\+h.


\begin{DoxyCode}
852         \{
853             static\_assert(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{double}) == \textcolor{keyword}{sizeof}(uint64\_t), \textcolor{stringliteral}{"double is not 64 bits"});
854 \textcolor{comment}{}
855 \textcolor{comment}{            /**}
856 \textcolor{comment}{             * @brief Write what the function does here}
857 \textcolor{comment}{             *}
858 \textcolor{comment}{             * @return}
859 \textcolor{comment}{             **/}
860             \textcolor{keyword}{union}
861             \{
862                 uint64\_t ival;
863                 \textcolor{keywordtype}{double} fval;
864             \};
865             fval = v;
866             \hyperlink{classWriter_aa2196ac25657790ad45fcd20e6fd8a3d}{writeU64}(ival);
867         \}
\end{DoxyCode}
...
\begin{DoxyCode}
777         \{
778             \hyperlink{classWriter_a87898dff934c55c144149029173fe66f}{writeU16}(v);
779         \}
\end{DoxyCode}
...
Definition at line 797 of file stream.\+h.


\begin{DoxyCode}
798         \{
799             \hyperlink{classWriter_ab8ed28096897dc429c95290542389224}{writeU32}(v);
800         \}
\end{DoxyCode}
...
\begin{DoxyCode}
819         \{
820             \hyperlink{classWriter_aa2196ac25657790ad45fcd20e6fd8a3d}{writeU64}(v);
821         \}
\end{DoxyCode}
...
922 \textcolor{comment}{                 * @brief Write what the function does here}
923 \textcolor{comment}{                 *}
924 \textcolor{comment}{                 * @param 0x1000}
925 \textcolor{comment}{                 *}
926 \textcolor{comment}{                 * @return}
927 \textcolor{comment}{                 **/}
928                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(ch < 0x1000)
929                 \{
930                     \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0xE0 | ((ch >> 12) & 0xF));
931                     \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0x80 | ((ch >> 6) & 0x3F));
932                     \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0x80 | ((ch) & 0x3F));
933                 \}
934 \textcolor{comment}{}
935 \textcolor{comment}{                /**}
936 \textcolor{comment}{                 * @brief Write what the function does here}
937 \textcolor{comment}{                 *}
938 \textcolor{comment}{                 * @return}
939 \textcolor{comment}{                 **/}
940                 \textcolor{keywordflow}{else}
941                 \{
942                     \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0xF0 | ((ch >> 18) & 0x7));
943                     \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0x80 | ((ch >> 12) & 0x3F));
944                     \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0x80 | ((ch >> 6) & 0x3F));
945                     \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0x80 | ((ch) & 0x3F));
946                 \}
947             \}
948             \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}(0);
949         \}
\end{DoxyCode}
...
\begin{DoxyCode}
766         \{
767             \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}((uint8\_t)(v >> 8));
768             \hyperlink{classWriter_a93d7ccb31453ec0f76ffe73b0ba6bb1b}{writeU8}((uint8\_t)(v & 0xFF));
769         \}
\end{DoxyCode}
...
\begin{DoxyCode}
787         \{
788             \hyperlink{classWriter_a87898dff934c55c144149029173fe66f}{writeU16}((uint16\_t)(v >> 16));
789             \hyperlink{classWriter_a87898dff934c55c144149029173fe66f}{writeU16}((uint16\_t)(v & 0xFFFF));
790         \}
\end{DoxyCode}
...
\begin{DoxyCode}
808         \{
809             \hyperlink{classWriter_ab8ed28096897dc429c95290542389224}{writeU32}((uint64\_t)(v >> 32));
810             \hyperlink{classWriter_ab8ed28096897dc429c95290542389224}{writeU32}((uint64\_t)(v & 0xFFFFFFFFU));
811         \}
\end{DoxyCode}
