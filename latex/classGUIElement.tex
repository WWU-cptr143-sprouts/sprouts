...
Definition at line 869 of file guicontainer.\+h.


\begin{DoxyCode}
870 \{
871     shared\_ptr<GUIContainer> retval = \hyperlink{classGUIElement_aded5837705c097a7a8a755df28c572e6}{getParent}();
872     \textcolor{keywordflow}{if}(retval == \textcolor{keyword}{nullptr})
873         \textcolor{keywordflow}{return} retval;
874     \textcolor{keywordflow}{while}(retval->getParent() != \textcolor{keyword}{nullptr})
875         retval = retval->getParent();
876     \textcolor{keywordflow}{return} retval;
877 \}
\end{DoxyCode}
