...
\begin{DoxyRetVals}{Return values}
{\em (variable)} & (description of variable) the determinant of this matrix \\
\hline
{\em (variable)} & (description of variable) \\
\hline
\end{DoxyRetVals}
...
\begin{DoxyRetVals}{Return values}
{\em (variable)} & (description of variable) the inverse of this matrix. \\
\hline
{\em (variable)} & (description of variable) \\
\hline
\end{DoxyRetVals}
...
\begin{DoxyRetVals}{Return values}
{\em (variable)} & (description of variable) the new rotation matrix \\
\hline
\end{DoxyRetVals}
...
\begin{DoxyRetVals}{Return values}
{\em (variable)} & (description of variable) the new scaling matrix \\
\hline
\end{DoxyRetVals}
...
\begin{DoxyRetVals}{Return values}
{\em (variable)} & (description of variable) the new translation matrix \\
\hline
\end{DoxyRetVals}
