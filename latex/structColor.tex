...
color with rgba in the range 0.\+0 to 1.\+0 
...
alpha value as a byte in the range 0 to 0x\+F\+F 
...
blue value as a byte in the range 0 to 0x\+F\+F 
...
\begin{DoxyCode}
397     \{
398         \textcolor{keywordtype}{float} minV = min(r, min(g, b));
399         \textcolor{keywordtype}{float} maxV = max(r, max(g, b));
400         \textcolor{keywordflow}{return} maxV - 0.5 * (1 - minV);
401     \}
\end{DoxyCode}
...
green value as a byte in the range 0 to 0x\+F\+F 
...
\begin{DoxyCode}
430 \{
431     \hyperlink{structColor_a183b93e13e713514a4bee5fdbd8a5a9b}{hue} -= floor(\hyperlink{structColor_a183b93e13e713514a4bee5fdbd8a5a9b}{hue});
432     \hyperlink{structColor_a225af5fdfba5d0d6d4d660a1f4c9a509}{saturation} = limit<float>(\hyperlink{structColor_a225af5fdfba5d0d6d4d660a1f4c9a509}{saturation}, 0, 1);
433     \hyperlink{structColor_a183b93e13e713514a4bee5fdbd8a5a9b}{hue} *= 6;
434     \hyperlink{structColor}{Color} retval = \hyperlink{structColor_a9a742cbe9f9f4037f5d9f4e81a9b2428}{Color}(0, a);
435 \textcolor{comment}{}
436 \textcolor{comment}{    /**}
437 \textcolor{comment}{     * @brief Write what the function does here}
438 \textcolor{comment}{     *}
439 \textcolor{comment}{     * @param hue}
440 \textcolor{comment}{     *}
441 \textcolor{comment}{     * @return}
442 \textcolor{comment}{     **/}
443     \textcolor{keywordflow}{switch}(ifloor(hue))
444     \{
445         \textcolor{keywordflow}{case} 0:
446             retval.r = 1;
447             retval.g = \hyperlink{structColor_a183b93e13e713514a4bee5fdbd8a5a9b}{hue};
448             \textcolor{keywordflow}{break};
449         \textcolor{keywordflow}{case} 1:
450             retval.g = 1;
451             retval.r = 2 - \hyperlink{structColor_a183b93e13e713514a4bee5fdbd8a5a9b}{hue};
452             \textcolor{keywordflow}{break};
453         \textcolor{keywordflow}{case} 2:
454             retval.g = 1;
455             retval.b = hue - 2;
456             \textcolor{keywordflow}{break};
457         \textcolor{keywordflow}{case} 3:
458             retval.g = 4 - \hyperlink{structColor_a183b93e13e713514a4bee5fdbd8a5a9b}{hue};
459             retval.b = 1;
460             \textcolor{keywordflow}{break};
461         \textcolor{keywordflow}{case} 4:
462             retval.b = 1;
463             retval.r = hue - 4;
464             \textcolor{keywordflow}{break};
465         \textcolor{keywordflow}{default}:
466             retval.r = 1;
467             retval.b = 6 - \hyperlink{structColor_a183b93e13e713514a4bee5fdbd8a5a9b}{hue};
468             \textcolor{keywordflow}{break};
469     \}
470     retval = interpolate(saturation, \hyperlink{structColor_a9a742cbe9f9f4037f5d9f4e81a9b2428}{Color}(1, a), retval);
471     \textcolor{keywordflow}{return} \hyperlink{structColor_ac863751b53da826f397a0a3e1791214c}{scale}(value, retval);
472 \}
\end{DoxyCode}
...
red value as a byte in the range 0 to 0x\+F\+F 
...
\begin{DoxyCode}
373     \{
374         \textcolor{keywordtype}{float} minV = min(r, min(g, b));
375         \textcolor{keywordtype}{float} maxV = max(r, max(g, b));
376         \textcolor{keywordflow}{if}(maxV == 0)
377             \textcolor{keywordflow}{return} 0;
378         \textcolor{keywordflow}{return} 1 - minV / maxV;
379     \}
\end{DoxyCode}
...
\begin{DoxyCode}
387     \{
388         \textcolor{keywordflow}{return} max(r, max(g, b));
389     \}
\end{DoxyCode}
...
{\em l} & \\
\hline
{\em r} & the color but not the alpha \\
\hline
\end{DoxyParams}
